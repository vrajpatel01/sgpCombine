...
export default function EditFacultyModel({ setData, currentUserData, setCoordinatorModel, setDeassignCoordinatorModel }) {
    ...
    return (
        <SheetContent className="space-y-5 overflow-y-scroll">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                }} variant='secondary'>Assign Coordinator</Button>
                <Button onClick={() => {
                    setData(false)
                    setDeassignCoordinatorModel(true)
                }} variant='secondary'>Deassign Coordinator</Button>
            </div>
            <Form {...form}>
