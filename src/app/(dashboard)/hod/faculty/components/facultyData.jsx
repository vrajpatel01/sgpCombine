...
import DeassignCoordinatorModel from "../models/deassignCoordinator"
...
export default function FacultyData({ selectedItem, setSelectedItem }) {
    ...
    const [deassignCoordinatorModel, setDeassignCoordinatorModel] = useState(false)
        ...
        <>
            ...
            <Sheet open={editFacultyModel} onOpenChange={setEditFacultyModel}>
                <EditFacultyModel
                    ...
                    setDeassignCoordinatorModel={setDeassignCoordinatorModel} />
            </Sheet>
            ...
            <Dialog open={deassignCoordinatorModel} onOpenChange={setDeassignCoordinatorModel}>
                <DeassignCoordinatorModel currentUserData={selectedFaculty} setDeassignCoordinatorModel={setDeassignCoordinatorModel} />
            </Dialog>
        </>
    )
}