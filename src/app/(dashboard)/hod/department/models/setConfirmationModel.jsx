        ...
        <PopUpModel
            ...
            <form onSubmit={handleDeleteConfirmation} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                    <div className="min-w-full sm:w-[350px] text-body-16 leading-5">Enter the your account password to continue.</div>
                    <InputField
                        type='password'
                    ...
                    <div className="w-full sm:w-[350px] leading-5">
                        {type == "semester" ? "Semester" : "Group selection"} Start from date <b>{selectedDates.start?.toDateString()}</b> and end on <b>{selectedDates.end?.toDateString()}</b>
                    </div>
