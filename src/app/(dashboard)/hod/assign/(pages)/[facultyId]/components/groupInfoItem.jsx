...
export default function GroupInfoItem({ group, className, onClick, checkBox, deassignBtn, onCheckBoxChange = () => { }, link = '' }) {
                ...
                <div onClick={(e) => {
                    ...
                    <div className="flex justify-between items-center w-full gap-3">
                        <div className="flex justify-center items-center gap-3">
                            ...
                            <div title="leader name" className="text-body-16 capitalize whitespace-nowrap">{group?.leader}</div>
                        </div>
                        {deassignBtn && <div onClick={(e) => {
                            e.stopPropagation()
            ...
            <Dialog open={deassignModel} onOpenChange={setDeasignModel}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Are you sure you want to deassign this group from the assigned faculty? Do you wish to proceed?</DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
