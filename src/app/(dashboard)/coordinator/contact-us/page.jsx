        ...
        <ContactUsCard
          ...
          social={
            <div className="flex justify-center items-center space-x-2">
              ...
              <Link
                target="_blank"
                href="https://www.linkedin.com/in/dhruvgiri-goswami"
              >
                <FaLinkedinIn size={18} />
              </Link>
            </div>
        ...
        <ContactUsCard
          ...
          social={
            <div className="flex justify-center items-center space-x-2">
              <Link
                target="_blank"
                href="https://www.linkedin.com/in/shaswat-kheni-487018299"
              >
                <FaLinkedinIn size={18} />
              </Link>
            </div>
...
function ContactUsCard({ name, studentId, email, role, social }) {
  return (
