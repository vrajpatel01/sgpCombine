...
export default function Students() {
  ...
  return (
    <div className="h-full">
              ...
              <div className="flex justify-center items-center gap-5">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="mr-4">
                    <DropdownMenuLabel>
                      Choose a method to add Account
                    </DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => {
      ...
      <Sheet
        open={addStudentByExcelModel}
        onOpenChange={setAddStudentByExcelModel}
      >
        <AddStudentByExcelModel
          data={addStudentByExcelModel}
          setData={setAddStudentByExcelModel}
        />
      </Sheet>
