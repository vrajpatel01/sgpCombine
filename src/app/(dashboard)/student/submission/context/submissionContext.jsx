...
import {
  useEditWeekInformation,
  useSaveWeekInformation,
...
export default function SubmissionContextProvider({ children }) {
  ...
  useEffect(() => {
    if (
      ...
      getWeeklySubmission.data.data !== null
    ) {
      setSubmission({
    ...
    if (!!getWeeklySubmission.data && getWeeklySubmission.data.data !== null) {
      return (
        submission.expectedOutcome !==
          getWeeklySubmission.data.data.expectedOutcome ||
    ...
    return updateWeeklySubmission.mutate(
      {
        ...
        ...(submission.studentsWork !==
          getWeeklySubmission.data.data.studentsWork && {
      ...
      return updateWeeklySubmission.mutate(
        {
          ...
          ...(submission.workDone !==
            getWeeklySubmission.data.data.workDone && {
            workDone: submission.workDone,
          }),
          ...(submission.studentsWork !==
            getWeeklySubmission.data.data.studentsWork && {
  ...
  return (
    <SubmissionContext.Provider
      value={{
        ...
        lock,
        isLeader,
        weekInfo: getWeeklySubmission.data,
