        ...
        <div className='max-w-[800px] mx-auto space-y-5'>
            <GeneralSettingsBlock
                ...
                <div>
                    ...
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="email" placeholder="example@example.com" value={data.email} />}
                </div>
                <div>
                    <Label htmlFor="enrollment">Enrollment</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="enrollment" placeholder="X00XXXXXX" value={data.rollNumber} />}
                </div>
                <div>
                    <Label htmlFor="phoneNumber">Phone Number</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="phoneNumber" placeholder="1234567890" value={data.phoneNumber} />}
                </div>
                <div>
                    <Label htmlFor="semester">Semester</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="semester" placeholder="6" value={data.semester} />}
                </div>
                <div>
                    <Label htmlFor="division">Division</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="division" placeholder="D" value={data.division} />}
                </div>
                <div>
                    <Label htmlFor="division">Institute</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="institute" placeholder="D" value={data.institute.name} />}
                </div>
                <div>
                    <Label htmlFor="division">Department</Label>
                    {me.isPending && <Skeleton className='w-full h-9' />}
                    {me.isSuccess &&
                        <Input disabled id="department" placeholder="D" value={data.department.name} />}
                </div>
            </GeneralSettingsBlock>
            <ChangePassword />
            <GeneralSettingsBlock
